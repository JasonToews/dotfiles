...
return {
  {
    ...
    config = function()
      ...
      local bgcolor = function() return "#011627" end
      ...
      table.insert(gls.left, {
        LspIcon = {
          provider = function()
            local name = ""
            if gl.lspclient ~= nil then name = gl.lspclient() end
            return "" .. name
          end,
      ...
      if package_info_present then
        table.insert(gls.right, {
          PackageInfoStatus = {
            provider = function() return package.get_status() .. " " end,
          },
        })
      end
      ...
      table.insert(gls.right, {
        VerticalPosAndSize = {
          provider = function() return string.format(" %s /%4i ", vim.fn.line ".", vim.fn.line "$") end,
          separator = "",
      ...
      table.insert(gls.right, {
        LineLength = {
          provider = function() return " " .. string.format("%3i", string.len(vim.fn.getline ".")) end,
